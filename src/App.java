...
private static double getExchangeRate(String fromCurrency, String toCurrency) {
    String apiKey = "a04b2b0063737a5a24fe2ee0"; //Clave de API
    String apiUrl = "https://v6.exchangerate-api.com/v6/a04b2b0063737a5a24fe2ee0/latest/USD" + apiKey + "/pair/" + fromCurrency + "/" + toCurrency;
